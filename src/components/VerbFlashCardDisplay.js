...
export default function VerbFlashCardDisplay(props) {

    const { verbArray, verbIndex, flip, shuffle, handleNextClick, handlePrevClick, handleFlipClick, handleShuffleClick } = props
