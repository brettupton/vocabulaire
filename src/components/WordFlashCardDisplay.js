...
export default function WordFlashCardDisplay(props) {
    ...
    const { wordArray, wordIndex, gender, flip, shuffle, handleNextClick, handlePrevClick, handleFlipClick, handleShuffleClick, isMobile } = props

    return (
        <div className="container min-vh-100 text-center pt-5 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div className="card-body p-0">
                            <div className="container p-0">
                                <div className="row justify-content-start m-1">
                                    <div className="col-2">
                                        {flip ? <img src={franceflag} id="word-flashcard-icon" alt="Flashcard Icon"/> : <img src={usflag} id="word-flashcard-icon" alt="Flashcard Icon"/>}
                                    </div>
                                </div>
                            </div>
